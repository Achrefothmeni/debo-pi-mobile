...
ImageViewer v = new ImageViewer(theme.getImage("deboblack.png"));
...
f.add(cc);
        ...
        try {
          ...
          f.getToolbar().addMaterialCommandToLeftSideMenu("profil", FontImage.MATERIAL_PEOPLE, ev -> new ListTasksForm(22,"ali"));
        f.getToolbar().addMaterialCommandToLeftSideMenu("magazins", FontImage.MATERIAL_HOME_WORK, ev -> new ListTasksForm(22,"ali"));
