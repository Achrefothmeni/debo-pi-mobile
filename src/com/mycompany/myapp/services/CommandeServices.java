  ...
  /*  public ArrayList<Commande> getCommande(String json)
    ...
    */
     ...
     public ArrayList<Commande> getCommandes(Integer id) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "https://depo-pi.herokuapp.com/api/afficherCommandeJson/" + id;
        con.setUrl(Url);
                ...
                for (Map<String, Object> obj : list) {
                 ...
                 // (int)Float.parseFloat(obj.get("id").toString());
                   c.setId((int)Float.parseFloat(obj.get("id").toString()));
                           c.setDateCommande(sdf.format(new Date((long)Float.parseFloat(obj.get("dateCommande").toString())))); 
                          c.setDateMax(dd.format(new Date((long)Float.parseFloat(obj.get("dateMax").toString()))));
                            c.setAddresse(obj.get("adresse").toString());
                    mapCommande.add(c);
